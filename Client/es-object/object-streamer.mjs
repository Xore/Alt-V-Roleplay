...
class ObjectStreamer {
    ...
    setTextureVariation(entityId, textureVariation = 1) {
        if (this.objects.hasOwnProperty(entityId)) {
            natives.setObjectTextureVariation(this.objects[entityId].handle, 1);
            this.objects[entityId].textureVariation = 1;
        }
    }
