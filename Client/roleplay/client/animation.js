...
import { AvailableDances, AvailableAnimations, AvailableWalks, AvailableAnimals, AvailableLays, AvailableSits } from './includes/emotes.js';
let prop = null;
const MenuSettings = {
...
alt.on("Client:Animation:Key113", () => {
