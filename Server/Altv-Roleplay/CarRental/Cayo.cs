    ...
    public class Main : IScript
    {
        ...
        public void StartMiniJob(IPlayer player, int level)
        {
            try
            {
                ...
                {
                    if (veh == null || !veh.Exists) continue;
                    if (veh.Position.IsInRange(Constants.Positions.CarRental_VehOutPos, 8f)) { HUDHandler.SendNotification(player, 3, 2500, "Der Hangar ist blockiert."); return; }
                }
                switch (level)
                {
                    case 1:
                        ...
                        ServerVehicles.CreateVehicle(4084658662, charId, 2, 0, false, 0, Constants.Positions.CarRental_VehOutPos, Constants.Positions.CarRental_VehOutRot, $"RENT-{charId}", 255, 255, 255);
                        break;
                    case 2:
                        ...
                        ServerVehicles.CreateVehicle(4173521127, charId, 2, 0, false, 0, Constants.Positions.CarRental_VehOutPos, Constants.Positions.CarRental_VehOutRot, $"RENT-{charId}", 255, 255, 255);
                        break;
                    case 3:
                        ...
                        ServerVehicles.CreateVehicle(1802742206, charId, 2, 0, false, 0, Constants.Positions.CarRental_VehOutPos, Constants.Positions.CarRental_VehOutRot, $"RENT-{charId}", 255, 255, 255);
                        break;
                }
