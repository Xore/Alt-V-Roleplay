...
namespace Altv_Roleplay.EntityStreamer
{
    ...
    public class Marker : Entity, IEntity
    {
        ...
        public Vector3 Rotation
        {
            ...
            {
                // No data changed
                if (Rotation != new Vector3(0, 0, 0) && Rotation.X == value.X && Rotation.Y == value.Y && Rotation.Z == value.Z && value != new Vector3(0, 0, 0))
                    return;
        ...
        public Vector3 Scale
        {
            ...
            {
                // No data changed
                if (Scale != new Vector3(0, 0, 0) && Scale.X == value.X && Scale.Y == value.Y && Scale.Z == value.Z && value != new Vector3(0, 0, 0))
                    return;
        ...
        public Vector3 Direction
        {
            ...
            {
                // No data changed
                if (Direction != new Vector3(0, 0, 0) && Direction.X == value.X && Direction.Y == value.Y && Direction.Z == value.Z && value != new Vector3(0, 0, 0))
                    return;
        ...
        public Rgba? Color
        {
            ...
            set
            {
                ...
                // No data changed
                if (Color != new Rgba(0, 0, 0, 0) && Color?.R == value?.R && Color?.G == value?.G && Color?.B == value?.B && Color?.A == value?.A)
                    return;
