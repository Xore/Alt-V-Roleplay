...
namespace Altv_Roleplay.models
{
    public partial class gtaContext : DbContext
    {
        ...
        public virtual DbSet<Server_Gangs> Server_Gangs { get; set; }
        public virtual DbSet<Server_Gang_Members> Server_Gang_Members { get; set; }
        public virtual DbSet<Server_Gang_Ranks> Server_Gang_Ranks { get; set; }
        public virtual DbSet<Server_Gang_Storage_Items> Server_Gang_Storage_Items { get; set; }
        public virtual DbSet<Server_Gang_Positions> Server_Gang_Positions { get; set; }
        ...
        public virtual DbSet<Server_IdentifiedVehicles> Server_IdentifiedVehicles { get; set; }
        ...
        public virtual DbSet<Handler.WeedPot> WeedPot { get; set; }
        public virtual DbSet<Handler.Object> Objects { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                //Lokal
                string connectionStr = $"server={Constants.DatabaseConfig.Host};uid={Constants.DatabaseConfig.User};password={Constants.DatabaseConfig.Password};database={Constants.DatabaseConfig.Database}";

                var conn = new SqlConnectionStringBuilder(connectionStr)
                {
                    Pooling = false
                };
                optionsBuilder.UseMySql(conn.ToString(), ServerVersion.AutoDetect(connectionStr));
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Accounts>(entity =>
            {
                ...
                entity.Property(e => e.whitelistTime).HasColumnName("whitelistTime");
            ...
            modelBuilder.Entity<Handler.WeedPot>(entity =>
            {
                entity.HasKey(e => e.id);
                entity.ToTable("server_weedpots", Constants.DatabaseConfig.Database);
                entity.HasIndex(e => e.id).HasDatabaseName("id");
                entity.Property(e => e.id).HasColumnName("id").HasColumnType("int(11)");
                entity.Property(e => e.remainingMinutes).HasColumnName("remainingMinutes").HasColumnType("int(11)");
                entity.Property(e => e.water).HasColumnName("water").HasColumnType("int(11)");
                entity.Property(e => e.hasFertilizer).HasColumnName("hasFertilizer");
                entity.Property(e => e.position).HasColumnName("position").HasConversion(
                    v => JsonConvert.SerializeObject(v),
                    v => JsonConvert.DeserializeObject<Position>(v));
                entity.Property(e => e.dimension).HasColumnName("dimension").HasColumnType("int(11)");
                entity.Property(e => e.state).HasColumnName("state").HasColumnType("int(11)");
            });

            modelBuilder.Entity<Handler.Object>(entity =>
            {
                entity.HasKey(e => e.id);
                entity.ToTable("server_objects", Constants.DatabaseConfig.Database);
                entity.HasIndex(e => e.id).HasDatabaseName("id");
                entity.Property(e => e.id).HasColumnName("id").HasColumnType("int(11)");
                entity.Property(e => e.remainingMinutes).HasColumnName("remainingMinutes").HasColumnType("int(11)");
                entity.Property(e => e.position).HasColumnName("position").HasConversion(
            ...
            modelBuilder.Entity<CharactersPhoneVerlauf>(entity =>
            {
                ...
                entity.HasIndex(e => e.charId).HasDatabaseName("charId");
                entity.Property(e => e.charId).HasColumnName("charId").HasColumnType("int(11)");
                entity.Property(e => e.phoneNumber).HasColumnName("phoneNumber").HasColumnType("int(11)");
                entity.Property(e => e.anotherNumber).HasColumnName("anotherNumber").HasColumnType("int(11)");
                entity.Property(e => e.date).HasColumnName("date");
            ...
            modelBuilder.Entity<Server_Doors>(entity =>
            {
                ...
                entity.Property(e => e.posY).HasColumnName("posY");
                entity.Property(e => e.posZ).HasColumnName("posZ");
                entity.Property(e => e.mainDoor).HasColumnName("mainDoor").HasMaxLength(64);
                entity.Property(e => e.secondDoor).HasColumnName("secondDoor").HasMaxLength(64);
            ...
            modelBuilder.Entity<Server_Gangs>(entity =>
            {
                entity.HasKey(e => e.id);
                entity.ToTable("server_gangs", Constants.DatabaseConfig.Database);
                entity.HasIndex(e => e.id).HasDatabaseName("id");
                entity.Property(e => e.id).HasColumnName("id").HasColumnType("int(11)");
                entity.Property(e => e.gangName).HasColumnName("gangName").HasMaxLength(128);
                entity.Property(e => e.gangShort).HasColumnName("gangShort").HasMaxLength(64);
            });

            modelBuilder.Entity<Server_Gang_Members>(entity =>
            {
                entity.HasKey(e => e.id);
                entity.ToTable("server_gang_members", Constants.DatabaseConfig.Database);
                entity.HasIndex(e => e.id).HasDatabaseName("id");
                entity.Property(e => e.id).HasColumnName("id").HasColumnType("int(11)");
                entity.Property(e => e.charId).HasColumnName("charId").HasColumnType("int(11)");
                entity.Property(e => e.gangId).HasColumnName("gangId").HasColumnType("int(11)");
                entity.Property(e => e.rank).HasColumnName("rank").HasColumnType("int(11)");
                entity.Property(e => e.lastChange).HasColumnName("lastChange");
            });

            modelBuilder.Entity<Server_Gang_Ranks>(entity =>
            {
                entity.HasKey(e => e.id);
                entity.ToTable("server_gang_ranks", Constants.DatabaseConfig.Database);
                entity.HasIndex(e => e.id).HasDatabaseName("id");
                entity.Property(e => e.id).HasColumnName("id").HasColumnType("int(11)");
                entity.Property(e => e.gangId).HasColumnName("gangId").HasColumnType("int(11)");
                entity.Property(e => e.rankId).HasColumnName("rankId").HasColumnType("int(11)");
            ...
            modelBuilder.Entity<Server_Gang_Storage_Items>(entity =>
            {
                entity.HasKey(e => e.id);
                entity.ToTable("server_gang_storage_items", Constants.DatabaseConfig.Database);
                entity.HasIndex(e => e.id).HasDatabaseName("id");
                entity.Property(e => e.id).HasColumnName("id").HasColumnType("int(11)");
                entity.Property(e => e.charId).HasColumnName("charId").HasColumnType("int(11)");
                entity.Property(e => e.gangId).HasColumnName("gangId").HasColumnType("int(11)");
            ...
            modelBuilder.Entity<Server_Gang_Positions>(entity =>
            {
                entity.HasKey(e => e.id);
                entity.ToTable("server_gang_positions", Constants.DatabaseConfig.Database);
                entity.HasIndex(e => e.id).HasDatabaseName("id");
                entity.Property(e => e.id).HasColumnName("id").HasColumnType("int(11)");
                entity.Property(e => e.gangId).HasColumnName("gangId").HasColumnType("int(11)");
                entity.Property(e => e.posType).HasColumnName("posType").HasMaxLength(64);
            ...
            modelBuilder.Entity<Server_Shops>(entity =>
            {
                ...
                entity.Property(e => e.bank).HasColumnName("bank").HasColumnType("int(11)");
                entity.Property(e => e.price).HasColumnName("price").HasColumnType("int(11)");
                entity.Property(e => e.pedPos).HasColumnName("pedPos").HasConversion(
                    v => JsonConvert.SerializeObject(v),
                    v => JsonConvert.DeserializeObject<Position>(v));
                entity.Property(e => e.shopPos).HasColumnName("shopPos").HasConversion(
                    v => JsonConvert.SerializeObject(v),
                    v => JsonConvert.DeserializeObject<Position>(v));
                entity.Property(e => e.managePos).HasColumnName("managePos").HasConversion(
                    v => JsonConvert.SerializeObject(v),
                    v => JsonConvert.DeserializeObject<Position>(v));
                entity.Property(e => e.pedModel).HasColumnName("pedModel").HasMaxLength(25);
                entity.Property(e => e.pedRot).HasColumnName("pedRot");
                entity.Property(e => e.blipColor).HasColumnName("blipColor").HasColumnType("int(11)");
                entity.Property(e => e.blipSprite).HasColumnName("blipSprite").HasColumnType("int(11)");
                entity.Property(e => e.type).HasColumnName("type").HasColumnType("int(11)");
                entity.Property(e => e.faction).HasColumnName("faction").HasColumnType("int(11)");
            ...
            {
                entity.HasKey(e => e.id);
                entity.ToTable("server_shops_items", Constants.DatabaseConfig.Database);
                entity.HasIndex(e => e.id).HasDatabaseName("id");
                entity.Property(e => e.id).HasColumnName("id").HasColumnType("int(11)");
