                ...
                if (player.AdminLevel() != 0)
                {
                    switch (action)
                    {
                        ...
                        case "heilen":
                            ...
                            DiscordLog.SendEmbed("adminmenu", "NightOut-Admin | Log", Characters.GetCharacterName((int)player.GetCharacterMetaId()) + "\nhat sich **geheilt **");
                            break;
                        case "wiederbeleben":
                            DeathHandler.revive(player);
                            Alt.Emit("SaltyChat:SetPlayerAlive", player, true);

                            DiscordLog.SendEmbed("adminmenu", "NightOut-Admin | Log", Characters.GetCharacterName((int)player.GetCharacterMetaId()) + "\nhat sich **wiederbelebt**.");
                            break;
                        // ONLINE
                        case "spieler_kicken":
                            ...
                            if (string.IsNullOrWhiteSpace(inputvalue))
                            {
                                ...
                                DiscordLog.SendEmbed("adminmenu", "NightOut-Admin | Log", Characters.GetCharacterName((int)player.GetCharacterMetaId()) + "\nhat " + Characters.GetCharacterName((int)kickedPlayer.GetCharacterMetaId()) + "\n**gekickt**.");
                            }
                            else
                            {
                                kickedPlayer.kickWithMessage("Du wurdest von einem Teammitglied gekickt. Grund: " + inputvalue);
                                DiscordLog.SendEmbed("adminmenu", "NightOut-Admin | Log", Characters.GetCharacterName((int)player.GetCharacterMetaId()) + "\nhat " + Characters.GetCharacterName((int)kickedPlayer.GetCharacterMetaId()) + " **gekickt**. \nGrund: " + inputvalue);
                            }
                            break;
                        case "spieler_bannen":
                            ...
                            if (string.IsNullOrWhiteSpace(inputvalue))
                            {
                                ...
                                DiscordLog.SendEmbed("adminmenu", "NightOut-Admin | Log", Characters.GetCharacterName((int)player.GetCharacterMetaId()) + "\nhat " + Characters.GetCharacterName((int)bannedPlayer.GetCharacterMetaId()) + " **gebannt**.");
                            }
                            else
                            {
                                ...
                                DiscordLog.SendEmbed("adminmenu", "NightOut-Admin | Log", Characters.GetCharacterName((int)player.GetCharacterMetaId()) + "\nhat " + Characters.GetCharacterName((int)bannedPlayer.GetCharacterMetaId()) + " **gebannt**. Grund: " + inputvalue);
                            }
                            break;
                        case "spieler_einfrieren":
                            ...
                            DiscordLog.SendEmbed("adminmenu", "NightOut-Admin | Log", Characters.GetCharacterName((int)player.GetCharacterMetaId()) + "\nhat " + Characters.GetCharacterName((int)kickedPlayerr.GetCharacterMetaId()) + " **eingefroren**.");
                            break;
