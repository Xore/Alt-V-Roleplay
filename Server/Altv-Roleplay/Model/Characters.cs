    ...
    class Characters : IScript
    {
        ...
        public static void SetCharacterPhoneEquipped(int charId, bool isPhoneEquipped)
        {
            try
            {
                ...
                using (var db = new gtaContext())
                {
                    ...
                    if (entry != null)
                    {
                        entry.isPhoneEquipped = isPhoneEquipped;
                    }
                    db.SaveChanges();
        ...
        public static void GenerateCharacterPhonenumber(IPlayer player, int charId)
        {
            try
            {
                ...
                using (var db = new gtaContext())
                {
                    var entry = db.AccountsCharacters.Find(charData.charId);
                    if (entry != null)
                    {
                        entry.phonenumber = generatedNumber;
                    }
                    db.SaveChanges();
        ...
        public static void SetCharacterLastPosition(int charId, Position pos, int dimension)
        {
            ...
            if (chars != null)
            {
                ...
                try
                {
                    using (gtaContext db = new gtaContext())
                    {
                        var entry = db.Characters_LastPos.Find(chars.charId);
                        if (entry != null)
                        {
                            entry.lastPosX = pos.X;
                            entry.lastPosY = pos.Y;
                            entry.lastPosZ = pos.Z;
        ...
        public static void RemoveCharacterPermission(int charId, string permission)
        {
            ...
            if (chars != null)
            {
                ...
                using (gtaContext db = new gtaContext())
                {
                    var entry = db.Characters_Permissions.Find(chars.charId);
            ...
            if (chars != null)
            {
                ...
                try
                {
                    using (gtaContext db = new gtaContext())
                    {
                        ...
                        if (entry != null)
                        {
                            entry.firstSpawnPlace = spawnplace;
            ...
            try
            {
                ...
                if (chars != null)
                {
                    ...
                    using (gtaContext db = new gtaContext())
                    {
                        ...
                        if (entry != null)
                        {
                            entry.isUnconscious = isUnconscious;
                            entry.unconsciousTime = unconsciousTime;
                        }
                        db.SaveChanges();
            ...
            try
            {
                ...
                if (chars != null)
                {
                    ...
                    using (gtaContext db = new gtaContext())
                    {
                        ...
                        if (entry != null)
                        {
                            entry.isFastFarm = isFastFarm;
                            entry.fastFarmTime = fastFarmTime;
                        }
                        db.SaveChanges();
