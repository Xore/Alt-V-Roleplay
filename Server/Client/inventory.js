...
alt.onServer('Client:Inventory:PlayScenario', (sceneName, duration, playEnterAnim) => {
    game.taskStartScenarioInPlace(alt.Player.local.scriptID, sceneName, duration, playEnterAnim);
});
