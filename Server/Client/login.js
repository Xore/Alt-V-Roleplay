...
function loadallIPLsAndInteriors() {
    ...
    let NewTunerinteriorID = game.getInteriorAtCoords(810.46170000, -962.07540000, 25.30295000);
    if (game.isValidInterior(NewTunerinteriorID)) {
        game.activateInteriorEntitySet(NewTunerinteriorID, 'entity_set_bedroom');
        game.activateInteriorEntitySet(NewTunerinteriorID, 'entity_set_bombs');
        game.activateInteriorEntitySet(NewTunerinteriorID, 'entity_set_cabinets');
        game.activateInteriorEntitySet(NewTunerinteriorID, 'entity_set_car_lift_default');
        game.activateInteriorEntitySet(NewTunerinteriorID, 'entity_set_car_lift_purchase');
        game.activateInteriorEntitySet(NewTunerinteriorID, 'entity_set_chalkboard');
        game.activateInteriorEntitySet(NewTunerinteriorID, 'entity_set_container');
        game.activateInteriorEntitySet(NewTunerinteriorID, 'entity_set_cut_seats');
        game.activateInteriorEntitySet(NewTunerinteriorID, 'entity_set_def_table');
        game.activateInteriorEntitySet(NewTunerinteriorID, 'entity_set_drive');
        game.activateInteriorEntitySet(NewTunerinteriorID, 'entity_set_ecu');
        game.activateInteriorEntitySet(NewTunerinteriorID, 'entity_set_IAA');
        game.activateInteriorEntitySet(NewTunerinteriorID, 'entity_set_laptop');
        game.activateInteriorEntitySet(NewTunerinteriorID, 'entity_set_lightbox');
        game.activateInteriorEntitySet(NewTunerinteriorID, 'entity_set_methLab');
        game.activateInteriorEntitySet(NewTunerinteriorID, 'entity_set_plate');
        game.activateInteriorEntitySet(NewTunerinteriorID, 'entity_set_scope');
        game.activateInteriorEntitySet(NewTunerinteriorID, 'entity_set_style_3');
        game.activateInteriorEntitySet(NewTunerinteriorID, 'entity_set_thermal');
        game.activateInteriorEntitySet(NewTunerinteriorID, 'entity_set_tints');
        game.activateInteriorEntitySet(NewTunerinteriorID, 'entity_set_train');
        game.activateInteriorEntitySet(NewTunerinteriorID, 'entity_set_virus');
        game.refreshInterior(NewTunerinteriorID);
    }
