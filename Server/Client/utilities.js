...
export function setCloth(player, arg) {
    const dlc = alt.hash("mp_m_male");
    player.setClothes(arg[0], arg[1], arg[2], arg[3], dlc);
    console.log(player, `Component: ${arg[0]}; drawable: ${arg[1]}; texture: ${arg[2]}; palette: ${arg[3]}; dlc: ${dlc}`);
}
...
alt.onServer("Client:Utilities:washVehicle", (vehicle) => {
    washVehicle(vehicle);
});
